...
namespace BethanyPieShopRazor.App.Models
{
    public class MockDataService
    {
        //The ! is used to suppress any nullability warnings that may arise
        //from assigning a nullable field a non-nullable value.
